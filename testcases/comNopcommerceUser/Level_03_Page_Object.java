...
//        basePage.clickToElement(driver,"//button[@id='register-button']");
        ...
        Assert.assertEquals(registerAction.getErrorMessageAtFirstnameTextbox(),"First name is required.");
        Assert.assertEquals(registerAction.getErrorMessageAtLastNameTextbox(),"Last name is required.");
        Assert.assertEquals(registerAction.getErrorMessageAtEmailTextbox(),"Email is required.");
        Assert.assertEquals(registerAction.getErrorMessageAtPasswordTextbox(),"Password is required.");
        Assert.assertEquals(registerAction.getErrorMessageAtConfirmPasswordTextbox(),"Password is required.");
